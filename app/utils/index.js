...
export default class Utils {
    ...
    static lhtLog(functionName, message, payload, developerAlias, logType = 'INFO') {
        const logData = `[${Utils.getFormattedDate()}] ${logType}: ${functionName}: ${message}: ${JSON.stringify(payload)}: ${developerAlias ? "Dev: " + developerAlias : ""}`
        logType === 'ERROR' ? console.error(logData) : console.log(logData)
    }
}
